    ...
    $scope.filesCreateFtn = function(){
        ...
        if(subscriberImage){
            ...
            cordova.exec(function(response){
                ...
                },function(e){alert("Fail: "+e); $ionicLoading.hide();}, "Echo", "echo", ["300","300","file", subscriberImage, "http://build.myappbuilder.com/api/files/new.json?", "post", {"api_key":loginStorage.api_key}])
